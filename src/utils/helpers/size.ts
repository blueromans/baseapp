...
export const size = (size_: number): number => {
  ...
  return ((SCREEN_HEIGHT / SCREEN_WIDTH) * size_) / multiplier;
};
...
export const fontSize = (fontSize_: number) => {
  ...
  const heightPercent = (fontSize_ * deviceHeight) / multiplier;
...
export const fontSizes = {
  largeTitle: fontSize(22), // ana ekran büyük başlık
  body: fontSize(13), // normal metin
  bodyLarge: fontSize(14), // biraz büyük metin
  headline: fontSize(19), // ekran başlığı
  subheadline: fontSize(17), // ara başlık / bölüm başlığı
  title: fontSize(17), // kart başlığı
  subtitle: fontSize(14), // kart alt başlığı
  button: fontSize(15), // buton yazıları
  overline: fontSize(10), // küçük üst yazılar (kategori)
  badgeLabel: fontSize(12), // etkinlik detayları için yönetici başılığı
  chartTitle: fontSize(68),
  chartSubtitle: fontSize(20),
};
export default size;
